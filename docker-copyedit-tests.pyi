...
def os_path(root: Optional[str], path: Optional[str]) -> str: ...
def decodes(text: Union[None,bytes,str]) -> str: ...
def lines(text: Union[str,List[str]]) -> List[str]: ...
def grep(pattern: str, lines: Union[str,List[str]]) -> None: ...
...
def sh(cmd: Optional[str] = ..., shell: bool = ..., check: bool = ..., ok: Optional[bool] = ..., default: str = ...) -> Result: ...
